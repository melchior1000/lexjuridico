...
const AK = process.env.ANTHROPIC_KEY || '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';

// Supabase
const SB_URL = process.env.SUPABASE_URL || 'https://tpzedlqzzktvkwtkvqjp.supabase.co';
const SB_KEY = process.env.SUPABASE_KEY || 'sb_publishable_PP1qCfMEbaAHSzp29A6WzQ_DeGBiHrp';
