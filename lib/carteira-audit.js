...
async function correctAndRefresh({processStore,processId,numero,now=new Date(),actor='advogado',dbReq=null,pje=null}){
  ...
  const extra={publicacoes:0,tribunal:'nao_conectado'};
  try{extra.publicacoes=(await require('./djen-monitor').attachOrphans({processStore,sbReq:dbReq,cnj})).casadas}catch{/* o Diário segue na leitura diária */}
