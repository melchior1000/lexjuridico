...
function intakeDecision(text, data = {}, history = []) {
  ...
  const replies = {
    ...
    identity: firstContact ? INTRO : (name ? 'Sou o LEX, ' + name + '. Trabalho no escritório LEX Jurídico e estou acompanhando seu atendimento. Em que posso te ajudar?' : 'Sou o LEX. Trabalho no escritório LEX Jurídico e estou acompanhando seu atendimento. Em que posso te ajudar?'),
