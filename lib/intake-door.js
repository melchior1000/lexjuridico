...
function intakeDecision(text, data = {}, history = []) {
  ...
  const replies = {
    ...
    identity: firstContact ? INTRO : (name ? 'Sou o ' + id.assistente + ', ' + name + '. Trabalho no ' + id.escritorioFrase + ' e estou acompanhando seu atendimento. Em que posso te ajudar?' : 'Sou o ' + id.assistente + '. Trabalho no ' + id.escritorioFrase + ' e estou acompanhando seu atendimento. Qual seu nome ou empresa, e em que posso te ajudar?'),
