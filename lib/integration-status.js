...
async function handleWhatsappOperatorCommand(body, instance, options = {}) {
  ...
  await _sendEvolutionText(operator,'Mesa do escritório.\n'+_listReceptionText(rows)+'\n\nQuem falou no 33672 aparece aqui. Responda: /responder NUMERO texto',instance,{url:cfg.url,key:cfg.key,request});
  return true;
}
