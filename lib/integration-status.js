...
async function whatsappStatus({url, key, instance, number, enabled = true}, getJson = requestJson) {
  ...
  } catch { return {...pending, estado:'falha_na_verificacao'}; }
}
...
module.exports = {brazilMobile, requestJson, evolutionEndpoint, whatsappStatus, telegramStatus, webhookAuthStatus};
