...
// a cada 5 min, 24 h por dia. Não substitui plano pago em produção.
function createKeepAlive({url,fetchImpl=globalThis.fetch,intervalMs=5*60*1000,log=()=>{},setTimer=setInterval,clearTimer=clearInterval}={}){
