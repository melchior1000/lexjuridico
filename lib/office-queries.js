...
const HELP=[
  'Sou o LEX, coordenador do escritório. Você não precisa escolher agente nem setor: diga o que quer, para quem e como quer que eu execute; eu encaminho internamente e volto com o resultado.',
  '',
  'Departamentos que eu coordeno:',
  '• Recepção — recebe clientes e mensagens, identifica a demanda e separa o que precisa da equipe.',
  '• Cadastro — organiza cliente, processo, documentos e dados faltantes antes da produção jurídica.',
  '• Processos — confere número, partes, vara, andamento e situação usando somente fontes disponíveis e identificadas.',
  '• Prazos / Controladoria — lê DJEN e expedientes disponíveis, organiza prazos confirmados e aponta o que depende de conferência.',
  '• Peças — prepara petições, contestações, recursos e minutas para revisão humana; essa produção usa IA quando necessário.',
  '• Perícia — organiza cálculos, quesitos, documentos e laudos; análise/redação técnica usa IA quando necessário.',
  '• Pesquisa — jurisprudência e perfil de julgador; depende de pesquisa/IA e fontes verificáveis.',
  '• Revisão — recebe o que os setores produziram, trava envio/protocolo e devolve para correção quando necessário.',
  '',
  'Exemplos de ordens que posso executar mesmo sem IA paga:',
  '• "prazos de hoje" / "prazos da semana" / "o que precisa de mim?"',
  '• "tem intimação nova?" / "teste o PJe" / "atualize meus processos"',
  '• "como está o processo 0000000-00.0000.0.00.0000"',
  '• "cadastre o processo 0000000-00.0000.0.00.0000"',
  '• "confira os números dos meus processos"',
  '• "responda a Maria: recebi os documentos"',
  '• "cadastre o cliente João"',
  '• "mande este processo para prazos porque saiu intimação"',
  '',
  'Análise jurídica livre, redação de peça, jurisprudência e texto pericial precisam de provedor de IA com crédito. Se o crédito acabar, o escritório continua operando e eu aviso somente na etapa que realmente precisa da IA.',
  'Protocolo, ciência de expediente, envio sensível e outros atos críticos continuam sujeitos à confirmação humana.'
].join('\n');
