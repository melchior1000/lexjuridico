...
async function syncProcessesFromPje({client,processStore,now=new Date(),processId=null}={}){
  ...
  const report={atualizados:[],sem_cnj:[],sem_tribunal:[],falhas:[],novos_andamentos:0,partes_atualizadas:0};
  for(const p of list){
...
module.exports={tribunalFromCnj,partesText,mergeCourtData,syncProcessesFromPje,syncReportMessage};
