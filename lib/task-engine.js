...
function defaultRuntimeInfo(){const model_provider=String(process.env.IA_PROVIDER||'anthropic').toLowerCase();const model_name=modelsFor(model_provider).top;return{model_provider,model_name};}
