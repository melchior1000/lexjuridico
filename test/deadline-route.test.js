...
function communication(){
  return{djen_id:'dj1',numero_oab:'123456',uf_oab:'MG',cnj:'50000000020268130001',tribunal:'TJMG',tipo:'Intimação',data_disponibilizacao:'2026-09-20',texto:'Manifestar',payload:{id:'dj1'},status:'casada',processo_id:'p1',prazo_cunhado:false,requisitado_em:'2026-09-20T08:00:00Z',observado_em:'2026-09-20T08:00:01Z',endpoint:'https://gateway.example/api/djen/comunicacao',request_id:'req1'};
}
