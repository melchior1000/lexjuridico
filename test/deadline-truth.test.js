...
function reading(over={}){
  ...
  return createReadingLogEntry({
    ...
    raw_receipt:'{"intimacao":"raw"}',sincronizado:true,explicit_no_change:true,due_at:'2026-09-30T23:59:59-03:00',
    ...over
  },{integrityKey:KEY});
}
function auth(over={}){return{id:'auth_1',reading_id:'read_1',process_id:'proc_1',human_id:'user_42',authorized_at:'2026-09-20T18:01:00.000Z',...over}}
